...
> ⚡ **ინტერნეტის სიჩქარე მნიშვნელოვანია:** ვინაიდან ყველა LLM გამოძახება (Query Expansion + პასუხის გენერირება) Google-ის Gemini API-ს სერვერებზე მიდის, **ინტერნეტის ხარისხი პირდაპირ გავლენას ახდენს პასუხის დროზე.** სწრაფი ინტერნეტით პასუხი რამდენიმე წამში დაბრუნდება, ხოლო ნელი კავშირის შემთხვევაში მოცდის დრო მნიშვნელოვნად გაიზრდება.
